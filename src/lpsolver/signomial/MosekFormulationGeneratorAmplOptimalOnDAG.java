...
/**
 * The optimal is constrained to be routable within the DAG
 * @author mosfet
 *
 */
public class MosekFormulationGeneratorAmplOptimalOnDAG implements IMosekFormulationGeneratorAmpl {
	...
	public MosekFormulationGeneratorAmplOptimalOnDAG(){
	...
	public void computeOptimalPerformance(String graphName, Graph g,
		...
		this.computeOptimalPerformance(graphName, g, setOfDemands,destination2ht ,destination2ht);
	}


	//compare against the optimal in destination2htOptimal
	public void computeOptimalPerformance(String graphName, Graph g,
			List<Pair<Integer>> setOfDemands,
			Map<Integer,Graph> destination2ht , Map<Integer,Graph> destination2htOptimal ){
		...
		try {
			...
			for(Integer destId:destinationVertices){
				...
				for(Vertex v : destination2htOptimal.get(destId).getVertices()){
					Map<Integer,Integer> edge2index = new HashMap<Integer,Integer>();
