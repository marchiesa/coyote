 ...
 *
 */
public class CompactLPSolverObliviousPerformanceGivenDemand {
	...
	public void computeObliviousPerformance(Graph g, List<Pair<Integer>> setOfDemands,Map<Integer,Map<Pair<Integer>,Double>> arc2demand2fraction){
		this.computeObliviousPerformance(g, setOfDemands,arc2demand2fraction, null,1,false);
	}

	public void computeObliviousPerformance(Graph g, List<Pair<Integer>> setOfDemands, Map<Integer,Map<Pair<Integer>,Double>> arc2demand2fraction,
			Map<Pair<Integer>,Double> demand2estimate, double w){
		this.computeObliviousPerformance(g, setOfDemands, arc2demand2fraction, demand2estimate, w, false);
	}
	 ...
	 */
	public void computeObliviousPerformance(Graph g, List<Pair<Integer>> setOfDemands, Map<Integer,Map<Pair<Integer>,Double>> arc2demand2fraction,
			Map<Pair<Integer>,Double> demand2estimate, double w, boolean AGGREGATE_CONGESTION){
