 ...
 *
 */
public class MainOptimalOblivious {
	...
	public static void main(String[] args) throws IOException, GRBException{
		...
		System.out.println("Most congested arc: " + g.getArcById(lps.getMostCongestedIdArc()));
		System.out.println();
		...
		lpsolver.computeObliviousPerformance(g, lps.getArc2demand2fraction() ,true);
		System.out.println( " Oblivious performance recomputed: " + lpsolver.getOpt());
		MainRacke.printDemands(lpsolver.getDemand2nameAndValue());
	}
	...
	public static String print(
		...
		for(Integer arcId : arc2demand2nameAndValue.keySet()){
			...
			for(Pair<Integer> demand:arc2demand2nameAndValue.get(arcId).keySet()){
				if(demand.getFirst()==1 && demand.getSecond()==2)
